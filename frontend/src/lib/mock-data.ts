...
export const mockReport: StructuredReport = {
  ...
  suggestedNextSteps: [
    ...
    "Correlate findings with radiographic assessment: Check if morphological patterns support or contradict CT/MRI findings.",
    "High attention in stromal regions may indicate desmoplastic reaction - consider stromal gene expression profiling if available.",
    "Review prior treatment history for anti-angiogenic therapy exposure and response patterns.",
    "Present case at multidisciplinary tumor board with full clinical context, imaging, and laboratory findings.",
